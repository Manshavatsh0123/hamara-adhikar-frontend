                        ...
                        >
                            <div
                                className="
                                    ...
                                    bg-white
                                    p-3
                                    shadow-[0_8px_28px_rgba(25,70,40,0.055)]
                                    transition-all
                                    duration-300
                                    hover:-translate-y-1
                                    hover:border-[#cfe2d5]
                                    hover:shadow-[0_16px_36px_rgba(20,80,40,0.10)]
                                "
                            >
                                <div
                                    className="
                                ...
                                >
                                    ...
                                    <div
                                        className="
                                            ...
                                            font-bold
                                            text-white
                                            shadow-[0_5px_14px_rgba(8,120,63,0.22)]
                                        "
                                    >
                                        {step.id}
                                    </div>
                                ...
                                >
                                    ...
                                    <span
                                        className="
                                            ...
                                            bg-white
                                            text-[#08783f]
                                            shadow-[0_3px_10px_rgba(25,70,40,0.06)]
                                        "
                                    >
                                        <ArrowRight
                                            size={14}
                ...
                <div className="mt-12 flex items-center justify-center sm:mt-14">
                    <div
                        className="
                            ...
                            px-4
                            py-2.5
                            shadow-[0_3px_12px_rgba(25,70,40,0.04)]
                        "
                    >
