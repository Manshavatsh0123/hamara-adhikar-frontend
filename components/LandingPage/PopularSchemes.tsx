...
export default function PopularSchemes() {
      ...
      <section className="w-full bg-white py-16 sm:py-20">
        <div className="mx-auto w-full max-w-[1200px] px-5 sm:px-6">
          <div className="mx-auto max-w-[650px] text-center">
            <div className="mx-auto h-4 w-32 animate-pulse rounded-full bg-[#edf3ef]" />
  ...
  if (error) {
    return (
      <section className="w-full bg-white py-16 sm:py-20">
        <div className="mx-auto w-full max-w-[1200px] px-5 sm:px-6">
          <div className="mx-auto max-w-[520px] rounded-2xl border border-[#e5ebe7] bg-[#fbfcfb] p-8 text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-[#737b87]">
              We could not load the latest government
    ...
    <section className="relative w-full overflow-hidden bg-white py-16 sm:py-20">
      ...
      <div className="relative mx-auto w-full max-w-[1200px] px-5 sm:px-6">
        ...
        <div className="mx-auto max-w-[700px] text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#dcebe0] bg-[#f6fbf7] px-4 py-2">
          ...
          <p
            className="
                        ...
                        "
          >
            Explore government schemes selected from
            across Bihar to help you find the support
            you need.
          </p>
        </div>
