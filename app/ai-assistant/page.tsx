...
} from "../../components/ai-assistant/eligibilityDetails";
...
export default function AIAssistantPage() {
    ...
    const handleCheckEligibility = () => {
         ...
         * Important:
         *
         * We only open the form here.
         *
         * The actual POST /api/eligibility
         * happens inside EligibilityDetails.
         */
                ...
                <div
                    className="
                        ...
                        bg-[radial-gradient(
                            ...
                            rgba(255,255,255,0.93)_32%,
                            rgba(255,255,255,0.65)_55%,
                            rgba(255,255,255,0.15)_80%,
                            transparent_100%
                        )]
                    "
                />
                        ...
                        >
                            ...
                            <div
                                className="
                                    ...
                                    font-medium
                                    text-[#267144]
                                    shadow-[0_4px_18px_rgba(8,120,63,0.08)]
                                    backdrop-blur-xl
                                "
                            >
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            className="
                                                                ...
                                                                py-3.5
                                                                text-white
                                                                shadow-[0_8px_26px_rgba(8,120,63,0.15)]
                                                            "
                                                        >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className="
                                                            ...
                                                            bg-white/95
                                                            text-[#08783f]
                                                            shadow-[0_4px_16px_rgba(8,120,63,0.10)]
                                                            backdrop-blur-xl
                                                        "
                                                    >
                ...
                >
                    ...
                    <div
                        className="
                            ...
                            bg-white/97
                            p-2
                            shadow-[0_15px_48px_rgba(26,69,43,0.16)]
                            backdrop-blur-2xl
                            transition-all
                            focus-within:border-[#b8d6c1]
                            focus-within:shadow-[0_17px_52px_rgba(26,69,43,0.20)]
                            sm:p-2.5
                        "
                    >
                        ...
                        >
                            ...
                            <button
                                ...
                                className="
                                    ...
                                    bg-[#08783f]
                                    text-white
                                    shadow-[0_5px_16px_rgba(8,120,63,0.22)]
                                    transition-all
                                    hover:bg-[#056b37]
